...
public:
  ...
  using row_type = VecNum<3, T>;
  using col_type = VecNum<3, T>;
...
public:
  ...
  KA_MATH_DEF Mat(T x1_, T y1_, T z1_, T x2_, T y2_, T z2_, T x3_, T y3_, T z3_) noexcept :
      x1(x1_), y1(y1_), z1(z1_), x2(x2_), y2(y2_), z2(z2_), x3(x3_), y3(y3_), z3(z3_) {}

  template<typename X1, typename Y1, typename Z1, typename X2, typename Y2, typename Z2,
           typename X3, typename Y3, typename Z3>
  KA_MATH_DEF Mat(X1 x1_, Y1 y1_, Z1 z1_, X2 x2_, Y2 y2_, Z2 z2_, X3 x3_, Y3 y3_, Z3 z3_) noexcept
      :
  ...
  KA_MATH_DEF Mat(const VecNum<3, V1>& v1, const VecNum<3, V2>& v2,
                  const VecNum<3, V3>& v3) noexcept :
...
public:
  ...
  template<math::numeric_convertible<T> U>
  KA_MATH_DECL Mat& operator=(const Mat<3, 3, U>& other) noexcept;
...
template<typename T>
KA_MATH_DECL bool operator==(const Mat<3, 3, T>& a, const Mat<3, 3, T>& b) noexcept;

template<typename T>
KA_MATH_DECL bool operator!=(const Mat<3, 3, T>& a, const Mat<3, 3, T>& b) noexcept;

template<typename T>
KA_MATH_DECL Mat<3, 3, T> operator+(const Mat<3, 3, T>& mat) noexcept;

template<typename T>
KA_MATH_DECL Mat<3, 3, T> operator+(const Mat<3, 3, T>& a, const Mat<3, 3, T>& b) noexcept;

template<typename T, math::numeric_convertible<T> U>
KA_MATH_DECL Mat<3, 3, T> operator+(const Mat<3, 3, T>& mat, U scalar) noexcept;

template<typename T, math::numeric_convertible<T> U>
KA_MATH_DECL Mat<3, 3, T> operator+(U scalar, const Mat<3, 3, T>& mat) noexcept;
...
template<typename T, math::numeric_convertible<T> U>
KA_MATH_DECL typename Mat<3, 3, T>::col_type operator*(const Mat<3, 3, T>& mat,
                                                       const VecNum<3, U>& vec) noexcept;

template<typename T, math::numeric_convertible<T> U>
KA_MATH_DECL typename Mat<3, 3, T>::row_type operator*(const VecNum<3, U>& vec,
...
template<typename T>
KA_MATH_DECL T determinant(const Mat<3, 3, T>& m) noexcept;

template<typename T>
KA_MATH_DECL Mat<3, 3, T> inverse(const Mat<3, 3, T>& m) noexcept;

template<typename T>
KA_MATH_DECL Mat<3, 3, T> transpose(const Mat<3, 3, T>& m) noexcept;
...
template<typename T, numeric_convertible<T> U>
KA_MATH_DECL Mat<3, 3, T> scale(const Mat<3, 3, T>& m, const VecNum<2, U>& v) noexcept;

template<typename T, numeric_convertible<T> U>
KA_MATH_DECL Mat<3, 3, T> rotate(const Mat<3, 3, T>& m, U ang) noexcept;

template<typename T, numeric_convertible<T> U>
KA_MATH_DECL Mat<3, 3, T> lookat_rh(const VecNum<3, T>& dir, const VecNum<3, U>& up) noexcept;

template<typename T, numeric_convertible<T> U>
KA_MATH_DECL Mat<3, 3, T> lookat_lh(const VecNum<3, T>& dir, const VecNum<3, U>& up) noexcept;

} // namespace kappa::math

#ifndef KA_MATH_MATRIX3X3_INL
