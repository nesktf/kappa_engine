...
KA_C_API const char* ka_vk_error_str(VkResult res);
...
KA_DECL_OPAQUE(ka_VulkanImage, 40, 8);
...
KA_C_API void ka_vk_image_extent(ka_VulkanImage const* image, VkExtent2D* extent);
...
KA_DECL_OPAQUE(ka_VulkanBuffer, 72, 8);
...
KA_DECL_OPAQUE(ka_VulkanShaderModule, 16, 8);
...
KA_DECL_OPAQUE(ka_VulkanCompute, 16, 8);
KA_DECL_OPAQUE(ka_VulkanPipeline, 16, 8);
...
KA_C_API void ka_vk_pipb_set_topology(VkPrimitiveTopology topology);
KA_C_API void ka_vk_pipb_set_poly_mode(VkPolygonMode mode, float width);
...
KA_C_API VkResult ka_vk_new_frame(ka_VulkanContext vk, VkCommandBuffer* cmd,
                                  VkImageLayout* draw_layout);
KA_C_API VkResult ka_vk_record_cmd(ka_VulkanContext vk, VkCommandBuffer cmd,
                                   ka_VulkanCommandData const* data);
KA_C_API VkResult ka_vk_record_compute(ka_VulkanContext vk, VkCommandBuffer cmd,
                                       ka_VulkanComputeData const* data);
KA_C_API VkResult ka_vk_end_frame(ka_VulkanContext vk, VkCommandBuffer cmd);
